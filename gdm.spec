...
# https://bugzilla.redhat.com/688323
Patch13: CVE-2011-0727.patch

# https://bugzilla.redhat.com/628462
Patch14: fix-layout-selection.patch

# https://bugzilla.redhat.com/723515
Patch15: fix-chooser-leak.patch

# https://bugzilla.redhat.com/624298
Patch16: fix-disable-restart-buttons.patch

# http://bugzilla.redhat.com/670619
Patch17: place-pointer-thoughtfully.patch

# https://bugzilla.redhat.com//show_bug.cgi?id=738462
Patch18: increase-verbosity.patch

# https://bugzilla.redhat.com/704245
Patch19: fix-xauth.patch

# https://bugzilla.redhat.com/show_bug.cgi?id=820058
Patch20: fix-window-warning.patch
...
%patch14 -p1 -b .fix-layout-selection
%patch15 -p1 -b .fix-chooser-leak
%patch16 -p1 -b .fix-disable-restart-buttons
%patch17 -p1 -b .place-pointer-thoughtfully
%patch18 -p1 -b .increase-verbosity
...
* Wed Sep 26 2012 Ray Strode <rstrode@redhat.com> 2.30.4-38
- allow smartcard with user list disabled
  Resolves: #719647

* Tue Sep 25 2012 Ray Strode <rstrode@redhat.com> 2.30.4-37
- Don't spam syslog when debugging is enabled
  Resolves: #834303

* Tue Sep 25 2012 Ray Strode <rstrode@redhat.com> 2.30.4-36
- Fix spurious "widget not within a GtkWindow" warning
  Resolves: #820058

* Tue Sep 25 2012 Ray Strode <rstrode@redhat.com> 2.30.4-35
- Use more compatible xauth host family
  Resolves: #704245

* Sun Mar 04 2012 Ray Strode <rstrode@redhat.com> 2.30.4-33
- Increase X server verbosity by default, and increase it even
  more when debug is enabled.
  Resolves: #738462

* Fri Aug 26 2011 Ray Strode <rstrode@redhat.com> 2.30.4-32
- Small fixes to message queue introduced in -30
  Related: #661618, #708430

* Sun Aug 14 2011 Ray Strode <rstrode@redhat.com> 2.30.4-31
- Rebuild with -fno-strict-aliasing to quiet rpmdiff
  Related: #670619, #661618, #708430, #688158, #645453, #628462, #622561

* Sun Aug 14 2011 Ray Strode <rstrode@redhat.com> 2.30.4-30
- Add small delay between consecutive messages,
  instead of immediately overwriting any previous messages.
  Resolves: #661618, #708430

* Fri Aug 12 2011 Ray Strode <rstrode@redhat.com> 2.30.4-29
- Don't show fingerprint icon if there are no fingerprint devices
  Resolves: #622561

* Mon Aug 08 2011 Ray Strode <rstrode@redhat.com> 2.30.4-28
- Place pointer thoughtfully, so it doesn't show up on a random
  monitor, or on top of the user list.
  Resolves: #670619

* Mon Aug 08 2011 Ray Strode <rstrode@redhat.com> 2.30.4-27
- Fix leak in xdmcp chooser
  Resolves: #723515
- Don't show shutdown/restart buttons when non-functional
  Resolves: #645453

* Fri Aug 05 2011 Ray Strode <rstrode@redhat.com> 2.30.4-25
- Fix keyboard layout selection
  Resolves: #628462

* Wed Jul 27 2011 Ray Strode <rstrode@redhat.com> 2.30.4-24
- defuzz patches so they're easier to update for upcoming
  errata.
  Related: #670619, #661618, #708430, #688158, #645453, #628462, #622561
- escape id calls so they don't fail with fully qualified
  network logon ids
  Resolves: #688158

* Thu Mar 24 2011 Ray Strode <rstrode@redhat.com> 2.30.4-23
- Fix CVE-2011-0727
